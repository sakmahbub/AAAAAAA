...
public class Display extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Evidence", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 3, 14))); // NOI18N
        ...
        chkSSC.setText("SSC");
        chkSSC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkSSCActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txtAge, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 211, Short.MAX_VALUE)
        ...
        tblDisplay.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Age", "Gender", "Education", "Round", "Note"
            }
        ));
    ...
    private void chkSSCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkSSCActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkSSCActionPerformed
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        String ID = "", name = "", email = "", age = "", gender = "", education = "", round = "", note = "";
        if (txtID.getText().length() < 1) {
        ...
        } else if (!chkSSC.isSelected() && !chkHSC.isSelected() && !chkHonours.isSelected() ) {
            JOptionPane.showMessageDialog(null, "Select Your Edu");
            ...
            if (chkHonours.isSelected()) {
                education += chkHonours.getText();
            }

            round = cmbRound.getItemAt(cmbRound.getSelectedIndex());
            note = msgNote.getText();

            Student std = new Student(ID, name, email, Integer.parseInt(age), gender, education, round, note);
            ...
            for (int i = 0; i < students.size(); i++) {
                ...
                model.addRow(row);
                try {
                    Utils.writeToFile("HaHa", students);
                } catch (Exception e) {
                }
    ...
    private void btnFileToTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFileToTableActionPerformed
        // TODO add your handling code here:
        String[] column = {"ID ", "Name ", "Email ", "Age ", "Gender ", "Education ", "Round ", "Note ",};
        DefaultTableModel model = new DefaultTableModel(0, 8);
        model.setColumnIdentifiers(column);
        tblDisplay.setModel(model);
        Utils.displayFromFile("HaHa", model);
